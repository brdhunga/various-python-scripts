...
if __name__=="__main__":
    ...
    for link in all_spans:
    	filename = link.a.string + ".pdf"
    	outputFilename = os.path.join(path2save, filename)
    	...
    	try:
    		convertHtmlToPdf(pagehtml, outputFilename)
    	except:
    		print "something went wrong in " + link.a.string
